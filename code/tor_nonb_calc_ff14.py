...
def tor_calc(torsion):
    ...
    fp2 = open('Amber_ff14_parameter/ff14-torsion.json', 'r')
    dic_tor = {}
    dic_tor = json.load(fp2)
    fp3 = open('Amber_ff14_parameter/ff14_num_KECSA2.json', 'r')
    dic_num_KECSA = {}
    ...
    fp5 = open('Amber_ff14_parameter/final_type.json', 'r')
    dic_nonb_types = {}
            ...
            for key in dic_6_ring_info:
                if torsion[key_1]['1_4_info'][i][0].split('_')[1] == torsion[key_1]['1_4_info'][i][1].split('_')[1]:
                    if torsion[key_1]['1_4_info'][i][0].split('_')[0] in dic_6_ring_info[key] and torsion[key_1]['1_4_info'][i][1].split('_')[0] in dic_6_ring_info[key]:
                        ...
                        Echarge = Echarge/2
            Etotal = Etor+Evdw/2+Echarge/1.2
            energy_info.append([key_1, str(Etor), str(Evdw), str(Echarge)])
...
def nonb_calc(nonbond):
    fp1 = open('Amber_ff14_parameter/ff14_KESCA2_num.json', 'r')
    dic_KECSA_num = {}
    dic_KECSA_num = json.load(fp1)
    fp2 = open('Amber_ff14_parameter/ff14_num_nonb.json', 'r')
    dic_num_nonb = {}
    dic_num_nonb = json.load(fp2)
    fp3 = open('Amber_ff14_parameter/final_type.json', 'r')
    dic_nonb_types = {}
