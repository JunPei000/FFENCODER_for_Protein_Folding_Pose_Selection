...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 25 12:51:54 2019
...
def protein_info(pdb):
    direct2 = 'reference/parm94-2.mol2'
    metal = ['Li', 'Na', 'K', 'Rb', 'Cs', 'Fr', 'Be', 'Mg', 'Ca', 'Sr', 'Ba', 'Ra', 'Sc', 'Y', 'Ti', 
             ...
             'Ge', 'Sn', 'Pb', 'Sb', 'Bi', 'Po']
    refer = open(direct2,'r').readlines()
